...
> 更新：2026-08-07（rebase 合并 origin Live2D + 本地文档收口）  
> 规范：`docs/workconnector-system-design.md` · 设计：`docs/workpet-connecter-design.md` · 下一步：`docs/NEXT-DEV-PATH.md`
...
见 **`docs/NEXT-DEV-PATH.md`**：

1. **P0.1** 本机 WorkPet 冒烟（用户；含 Live2D）  
2. **P0.2–P0.3** ✅ API + 运维文档  
3. **P1** 公网前 443 / CORS / token 轮换  
4. **P2** WP→Connecter 回连 + 全文回显  
